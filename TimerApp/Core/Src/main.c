...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : BTN_DOWN_Pin BTN_LEFT_Pin BTN_ESC_Pin BTN_GO_Pin
                           BTN_UP_Pin BTN_RIGHT_Pin */
  GPIO_InitStruct.Pin = BTN_DOWN_Pin|BTN_LEFT_Pin|BTN_ESC_Pin|BTN_GO_Pin
                          |BTN_UP_Pin|BTN_RIGHT_Pin;
